...
namespace EmployeeManagement.API.Migrations
{
    ...
    [Migration("20200205092810_Initial")]
            ...
            modelBuilder.Entity("EmployeeManagement.Core.Models.Duty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDone = false,
                            OrderDate = new DateTime(2020, 2, 5, 10, 28, 9, 954, DateTimeKind.Local).AddTicks(1344)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ExecutiveEmployeeId = 1,
                            IsDone = false,
                            OrderDate = new DateTime(2020, 2, 5, 10, 28, 9, 954, DateTimeKind.Local).AddTicks(7420)
                        });
                });
            ...
            modelBuilder.Entity("EmployeeManagement.Core.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CityId = 1,
                            EmploymentDate = new DateTime(2020, 2, 5, 10, 28, 9, 948, DateTimeKind.Local).AddTicks(615),
                            FirstName = "Jan",
                            JobId = 1,
                            LastName = "Kowalski"
                        },
                        new
                        {
                            Id = 2,
                            CityId = 1,
                            EmploymentDate = new DateTime(2020, 2, 5, 10, 28, 9, 953, DateTimeKind.Local).AddTicks(8083),
                            FirstName = "Janina",
                            JobId = 1,
                            LastName = "Kowalska"
                        });
